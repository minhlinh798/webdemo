...
.nav-item .pagesmenu .collapse-item {
    ...
    display: block; /* Đảm bảo link chiếm toàn bộ phần container */
    padding: 8px 12px; /* Khoảng cách bên trong link */
...
<li class="nav-item">
    <div class="pagesmenu">
        <a class="collapse-item" href="addsp.php">Thêm Sản Phẩm</a>
    </div>
</li>
<!-- Nav Item - Charts -->
<li class="nav-item">
